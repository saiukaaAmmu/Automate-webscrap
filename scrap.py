...
#C:\Users\webdriver
driver = webdriver.Chrome('C:/Users/webdriver/chromedriver.exe')
driver.get('https://www.boxofficemojo.com/chart/top_lifetime_gross/?area=XWW')
## Scraping Movie Names
movies_names = driver.find_elements('By.XPATH,.//td[@class="a-text-left mojo-field-type-title"]/a[@class="a-link-normal"]')  ## targets all the elements on the web that has same Xpath
